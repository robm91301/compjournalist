...
# unzip the data file
if (!file.exists("arrest_data.csv")) { unzip("data.zip") }
# read the data in
if (!file.exists("arrest_data.csv")) { stop("No Data File")}
...
# do another table on gender, arrests, and days
y = xtabs(~ Arrest.Type.Code + Days + Sex.Code , df)
print(y)
# do another table but see how ethnicity plays ino the information
